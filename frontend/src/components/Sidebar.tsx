...
const Sidebar = ({ params }: { params: Promise<{ id: string }> }) => {
  ...
  // Combine all projects for the popover
    ...
    <>
      ...
      <div className={`${isOpen ? 'w-64' : 'w-0'} bg-gray-900 text-white flex flex-col transition-all duration-300 overflow-hidden`}>
            ...
            <Popover open={popoverOpen} onOpenChange={setPopoverOpen}>
              ...
              >
                  ...
                  <div className="space-y-1">
                    <div className="flex items-center gap-3 py-2 px-3 bg-gray-100 hover:bg-gray-200 rounded cursor-pointer">
        ...
        <div className="p-4 border-2 border-gray-800 min-w-[256px]">
          <Button className="w-full bg-[#2A2B2D] border-[0.3px] text-white hover:bg-[#2A2B2E] hover:text-white mt-2">
