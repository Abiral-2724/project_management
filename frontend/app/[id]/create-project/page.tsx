...
export default function WorkflowGallery({params} : any) {
      ...
      <header className="bg-white border-b border-gray-200 px-6 py-3">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            <h1 className="text-xl font-light text-blue-950">Workflow gallery</h1>
            <Badge variant="secondary" className="bg-blue-100 text-blue-700 hover:bg-blue-100">
              New
            </Badge>
          </div>
          <div className="flex items-center gap-3">
            <Button className="gap-2 bg-blue-900 hover:bg-blue-800" onClick={() => router.push('/project/new')}>
                
                <Plus className="w-4 h-4" />
              Blank project
            
            </Button>
            <Button variant="ghost" size="icon" onClick={() => router.push(`/${id}/home`)}>
                
                <X className="w-5 h-5 text-blue-950 bg-gray-100" />
      ...
      <main className="px-6 py-12 max-w-7xl mx-auto">
        ...
        <div className="mb-16">
          <div className="flex items-center justify-between mb-6">
            <div>
              <h2 className="text-3xl font-light mb-2 text-blue-900">Workflows built for all teams</h2>
              <p className="text-gray-600 text-sm">Help your teams track, plan, and deliver impactful work in Planzo</p>
            </div>
  ...
  <div className="pt-2">
   <img src={workflow.visual} alt="" />
        ...
        <div>
          <div className="mb-6">
            <h2 className="text-3xl font-light mb-2 text-blue-900">Start working in seconds</h2>
            <p className="text-gray-600 text-sm">Power your everyday processes with Asana's most popular workflows</p>
          </div>
